...
export default function Prolearn() {
  ...
  return (
    <div className="relative  w-full bg-white">
      ...
      <div className="relative flex flex-col z-10 p-5">
        <h1 className="text-[#003663] text-4xl font-bold w-full text-center">
          Pro Learn
        </h1>

        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 mt-5 px-20 w-[99%]">
          {coursecard.map((card, i) => (
            ...
            >
              ...
              <div className="flex justify-between w-full p-2 text-sm text-gray-700">
                <span>{card.Code}</span>
              ...
              <div className="text-start  w-full p-3 text-black text-sm">
                {card.Title}
              </div>
            </div>
          ))}
